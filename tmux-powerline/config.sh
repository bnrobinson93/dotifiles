...
# General {{{
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="night-owl"
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/brad/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/brad/.mailcheckrc"
# }
...
# weather.sh {
	...
	TMUX_POWERLINE_SEG_WEATHER_LAT="33.44430160522461"
	TMUX_POWERLINE_SEG_WEATHER_LON="-86.75360107421875"
# }
